...
phoneme_table = [
	{'arpabet': 'AA',  'ipa': 'ɑ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'AE',  'ipa': 'æ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'AH',  'ipa': 'ʌ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'AO',  'ipa': 'ɔ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'AW',  'ipa': 'aʊ̯', 'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'AX',  'ipa': 'ə',  'type': SCHWA,     'accent': ['ipa', 'arpabet', 'festlex']},
	{'arpabet': 'AXR', 'ipa': 'ɚ',  'type': SCHWA,     'accent': ['ipa', 'arpabet']},
	{'arpabet': 'AY',  'ipa': 'aɪ̯', 'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'B',   'ipa': 'b',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'CH',  'ipa': 't͡ʃ', 'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'D',   'ipa': 'd',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'DH',  'ipa': 'ð',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'DX',  'ipa': 'ɾ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'EH',  'ipa': 'ɛ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'EL',  'ipa': 'l̩',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'EM',  'ipa': 'm̩',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'EN',  'ipa': 'n̩',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'ENG', 'ipa': 'ŋ̍',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'ER',  'ipa': 'ɝ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'EY',  'ipa': 'eɪ̯', 'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'F',   'ipa': 'f',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'G',   'ipa': 'ɡ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'HH',  'ipa': 'h',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'HW',  'ipa': 'ʍ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']}, # extension (WINE-WHINE)
	{'arpabet': 'IH',  'ipa': 'ɪ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'IY',  'ipa': 'i',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'JH',  'ipa': 'd͡ʒ', 'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'K',   'ipa': 'k',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'L',   'ipa': 'l',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'M',   'ipa': 'm',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'N',   'ipa': 'n',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'NG',  'ipa': 'ŋ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'NX',  'ipa': 'ɾ̃',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'OW',  'ipa': 'oʊ̯', 'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'OY',  'ipa': 'ɔɪ̯', 'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'P',   'ipa': 'p',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'Q',   'ipa': 'ʔ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']},
	{'arpabet': 'R',   'ipa': 'ɹ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'S',   'ipa': 's',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'SH',  'ipa': 'ʃ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'T',   'ipa': 't',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'TH',  'ipa': 'θ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'UH',  'ipa': 'ʊ',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'UW',  'ipa': 'u',  'type': VOWEL,     'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'V',   'ipa': 'v',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'W',   'ipa': 'w',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'X',   'ipa': 'x',  'type': CONSONANT, 'accent': ['ipa', 'arpabet']}, # extension (Scottish <loch>)
	{'arpabet': 'Y',   'ipa': 'j',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'Z',   'ipa': 'z',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
	{'arpabet': 'ZH',  'ipa': 'ʒ',  'type': CONSONANT, 'accent': ['ipa', 'arpabet', 'cmudict', 'festlex']},
]
